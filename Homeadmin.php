...
<body style="overflow:hidden">
  ...
  /*
    ...
    */
    ...
    <section>
        <form name="admin" method="post" action="#" onSubmit="return valid();">
            <div id="home">
            ...
            <div id="settings">
                <h4>
                    <div class="card">
                        ...
                        <br><br><br>
                        <tr>
                            <input type="submit" name="ChangePassowrd" value="Change Passowrd" id="btneditpass">
                        </tr>
                    </div>
                </h4>
            </div>
...
<script type="text/javascript">
    function valid()
    {
        if(document.admin.opwd.value=="")
        {
            alert("Old Password Field is Empty !!");
            document.admin.opwd.focus();
            return false;
        }
        else if(document.admin.npwd.value=="")
        {
            alert("New Password Field is Empty !!");
            document.admin.npwd.focus();
            return false;
        }
        else if(document.admin.cpwd.value=="")
        {
            alert("Confirm Password Field is Empty !!");
            document.admin.cpwd.focus();
            return false;
        }
        else if(document.admin.npwd.value!= document.admin.cpwd.value)
        {
