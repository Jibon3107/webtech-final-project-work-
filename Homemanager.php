                    ...
                    <div class="card">
                        ...
                        <table style="width:100%; font-size:17px; text-align: left;letter-spacing: 2px;margin-left: 20px;">
                            <tr>
                                ...
                                <td>
                                    <div class="textbox"><input style="font-size: 13px;" type="text" placeholder="Current Password" name="currentpass"></div>
                                </td>
                            </tr>
                            <br>
                            <tr>
                                ...
                                <td>
                                    <div class="textbox"><input style="font-size: 13px;" type="text" placeholder="New Password" name="newpass"></div>
                                </td>
                            </tr>
                            <br>
                            <tr>
                                ...
                                <td>
                                    <div class="textbox"><input style="font-size: 13px;" type="text" placeholder="Confirm Password" name="connfirmpass"></div>
                                </td>
                            </tr>
                        </table>
                        <br><br><br>
